        ...
        <v-col sm="6" cols="12" class="align-self-center mt-2 pb-5">
          <v-row>
            ...
            :rules="[(value) => {
              ...
              single-line :disabled="!search_param || !file_status" :lazy="true" ref="second_field" >
            </v-text-field>
            <v-btn :disabled="!search_param || !file_status?!btn_state:btn_state" class="mr-5" icon="mdi-magnify" @click="search_btn">
            </v-btn>
          </v-row>
        </v-col>
      </v-row>
